...
TIER = {'pk': 0, 'iptv-org': 1, 'epgshare01': 2, 'epg.pw': 3, 'provider': 4}
...
COUNTRY_SOURCES = {
    ...
    'UK': ['UK1', 'IE1'], 'IE': ['UK1', 'IE1'],
    'CA': ['CA2'], 'DE': ['DE1'], 'FR': ['FR1'], 'IT': ['IT1'],
    'GR': ['GR1'], 'RO': ['RO1', 'RO2'], 'ES': ['ES1'], 'PL': ['PL1'],
    'PT': ['PT1'], 'AU': ['AU1'], 'ZA': ['ZA1'], 'PH': ['PH1', 'PH2'],
